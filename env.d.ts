...
declare namespace Cloudflare {
	interface Env {
        GROQ_API_KEY: string;
        ATHENA_AI_PROJECTS: KVNamespace;
        ATHENA_AI_HISTORIES: KVNamespace;
        GOOGLE_GEMINI_API_KEY: string;
        GITHUB_SERVICE_ACCOUNT_PAT: string;
        // ANTHROPIC_API_KEY: string;
        // GITHUB_APP_GITHUB_APP_ID: string,
        // GITHUB_APP_GITHUB_CLIENT_ID: string,
        // GITHUB_APP_GITHUB_CLIENT_SECRET: string,
        // GITHUB_APP_GITHUB_WEBHOOK_SECRET: string,
        // GITHUB_APP_GITHUB_PRIVATE_KEY: string,
        // OAUTH_APP_GITHUB_CLIENT_ID: string,
        // OAUTH_APP_GITHUB_CLIENT_SECRET: string,
        // AUTH_SECRET: string
	}
}
